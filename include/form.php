...
$toemails[] = array(
				'email' => 'timmndirangu1@mail.com', // Your Email Address
				'name' => 'Timm' // Your Name
			);
...
$fromemail = array(
				'email' => 'iveec@botleo.co.ke', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Iveec' // Company Name
			);
